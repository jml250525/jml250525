...
<ol><li><se><strong>Network Asymmetry and Supply Contract Competition</strong></se>
  ...
  <li><p style="font-size:16px;">In preparation for submission to <em>Management Science</em></p></li>
  <li><details class=abstract style="font-size:16px;"><summary markdown=span>Abstract (click to expand)</summary>
We build a game-theoretic model to examine the role of asymmetry of bilateral relations in supply contract negotiations under retailer-side and supplier-side competition. We represent the asymmetric bilateral relationships with a two-retailer-two-supplier network in which one retailer has access to both suppliers and other retailer has access to only one supplier. The retailers first negotiate supply contracts with their suppliers to gain exclusive selling rights and then the retailers who manage to secure a contract with a supplier choose their purchase quantities. We find that the asymmetric structure of supply network together with the product substitutability level determine the contract bargaining incentives of retailers and suppliers under competition. Specifically, the asymmetric supply chain network can lead to a retail monopoly when the suppliers' products are sufficiently substitutable. Further, if the substitutability level continues to rise, the retailer with a ``relationship advantage" gain benefits in contract agreement through negotiations. We also show that supply chain profits can be higher under asymmetric network structure as compared to that under complete network structure. Overall, our research highlights the implications of asymmetric supply chain network on firms' contracting behaviors, and sheds light on firms' sourcing strategy of not only focusing on the best terms of trade from the partners but also considering the competitive consequences of partner choice.</details></li>
   </ul>
 </li></ol>
...
<ol start=4><li><se><strong>Can Artificial Intelligence Discover Trust and Trustworthiness?</strong></se>
  ...
  <li><p style="font-size:16px;">In preparation for submission to <em>Science</em></p></li>
  <li><details class=abstract style="font-size:16px;"><summary markdown=span>Abstract (click to expand)</summary>
