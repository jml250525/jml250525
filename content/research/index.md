...
<ol><li><se><strong>Network Asymmetry and Supply Contract Competition</strong>. Joint work with Alper Nakkas and Kay-Yut Chen. will submit to <em>Management Science</em>.</se>
  <ul>
  <li><p style="font-size:16px;">Authors: </p></li>  
  <li><p style="font-size:16px;">Target at <em>Management Science</em></p></li></ul>
  <details class=abstract style="font-size:16px;"><summary markdown=span>Summary (click to expand)</summary>
